...
export class PatchFrom14To015 implements Patch {
    from(): string {
        return "0.14"
    }
    to(): string {
...
export class PatchFrom19To020 implements Patch {
    from(): string {
        return "0.19"
    }
    to(): string {
...
export class PatchFrom20To021 implements Patch {
    from(): string {
        return "0.20"
    }
    to(): string {
...
const PATCHES = [
    ...
    new PatchFrom19To020(),
    new PatchFrom20To021(),
]
