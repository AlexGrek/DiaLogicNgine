...
import Dialog, { DialogWindow, createDialogLink, createWindow } from '../../game/Dialog';
...
const ChainEditor: React.FC<ChainEditorProps> = ({ visible, onSetVisible, onApply, dialog }) => {
        ...
        <Drawer placement="right" open={visible} onClose={() => onSetVisible(false)}>
            <Drawer.Header>
                ...
                <Drawer.Actions>
                    ...
                    <Button onClick={() => apply()} appearance="primary">
                        Generate
                    </Button>
                </Drawer.Actions>
            </Drawer.Header>
