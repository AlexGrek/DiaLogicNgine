...
export const DEFAULT_ARGS = {
    ...
    "rt.history.dialogVisited()": "rt.history.dialogVisited(dialog, window?) => boolean: has the player been in this dialog window (or any window of the dialog) before",
    "rt.history.visitedDialogs": "rt.history.visitedDialogs => string[]: names of all visited dialogs",
    "rt.history.visitedDialogWindows": "rt.history.visitedDialogWindows => string[]: all visited windows as 'dialog::window' keys, in visit order",
